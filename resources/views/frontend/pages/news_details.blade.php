...
<div class="container-fluid section-details border-top mt-80">
  ...
  <div class="text-center mb-4">
    <p class="small mb-2 text-secondary">বিজ্ঞাপন</p>
    <div class="d-flex justify-content-center">
      <div class="border rounded p-2 bg-light" style="min-height:90px;">
        <!-- Google Ad Frame -->
         <img src="https://tpc.googlesyndication.com/simgad/11458218291210740407">
        <iframe class="d-none" src="about:blank"
          title="Advertisement"
          width="728" height="90"
  ...
  <div class="row g-4">
    @foreach ($mostViews as $i=>$item)
      <div class="col-md-4 right-border">
        <a href="{{ route('newsDetails', $item->slug) }}" class="text-decoration-none text-dark">
          <div class="position-relative mb-2 overflow-hidden ">
            <img src="{{ asset(getMedia($item->id, 1, 1)) }}"
                class="img-fluid  transition" alt="{{ $item->slug }}">
        ...
        <div class="col-md-3 col-12 ">
            ...
            <div class="more-content sticky">
                <div class="more-read top-border bottom-border">
                    <p class="title-blue">আরও পড়ুন</p>
                    <p class="top-border bottom-border">বিএনপি ক্ষমতায় এলে শিক্ষা ব্যবস্থার উন্নতি হবে : আফরোজা</p>
                    <p class=" ">নির্বাচন নিরপেক্ষ করার জন্য যা দরকার করবো, বিএনপিকে প্রধান উপদেষ্টা</p>
                    <div class="sidebar-add ">
                <img src="https://tpc.googlesyndication.com/simgad/11373802009826816949" class="img-fluid mobile-image">
                 <p class="top-border ">প্রধান উপদেষ্টার সঙ্গে দেখা করতে যমুনায় বিএনপির প্রতিনিধি দল </p>
            </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    var offset = 20; // distance from top

    $(window).on('scroll', function() {
        var scrollTop = $(window).scrollTop();

        if(scrollTop + offset > sidebarTop) {
            // check if sidebar reached bottom of main content
